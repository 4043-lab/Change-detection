...
class ChannelAttention(nn.Module):
    def __init__(self, in_ch, ratio=8):
        ...
        self.fc1 = nn.Sequential(nn.Conv2d(in_ch, in_ch // ratio, kernel_size=1, bias=False),
                                 nn.ReLU())
...
class SNUNet(nn.Module):
    def __init__(self, in_ch=3, out_ch=2, width=32):
        ...
        self.down1 = nn.MaxPool2d(kernel_size=2, stride=(2, 2), padding=(0, 0))
        self.down2 = nn.MaxPool2d(kernel_size=2, stride=(2, 2), padding=(0, 0))
        self.down3 = nn.MaxPool2d(kernel_size=2, stride=(2, 2), padding=(0, 0))
        self.down4 = nn.MaxPool2d(kernel_size=2, stride=(2, 2), padding=(0, 0))
        ...
        self.conv_out = nn.Conv2d(filters[0]*4, out_ch, kernel_size=1, padding=0, stride=1, bias=True)
