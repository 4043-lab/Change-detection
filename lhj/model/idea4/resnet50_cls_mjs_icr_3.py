...
class Network(nn.Module):
    ...
    def forward_affine(self, t):
        ...
        trf = transforms.Compose([
            transforms.Resize(int(t1.shape[-1]/2)),
        ...
        return cam2, cam3, cam4, cam5

    def forward(self, t):
        cam2, cam3, cam4, cam5, out2, out3, out4, out5 = self.forward_origin(t)
        cam2_, cam3_, cam4_, cam5_ = self.forward_affine(t)
        return cam2, cam3, cam4, cam5, cam2_, cam3_, cam4_, cam5_, out2, out3, out4, out5
