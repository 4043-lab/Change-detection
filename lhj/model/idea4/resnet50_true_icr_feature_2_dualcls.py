...
class Network(nn.Module):
    ...
    def forward_origin(self, t):
        ...
        return cam, out1, out2, out3, x1_e1, x2_e1, x3_e1, x4_e1, x1_e2, x2_e2, x3_e2, x4_e2, out
    ...
    def forward(self, t):
        cam, out1, out2, out3, x1_e1, x2_e1, x3_e1, x4_e1, x1_e2, x2_e2, x3_e2, x4_e2, out = self.forward_origin(t)
        cam_, out1_, out2_, out3_, out_ = self.forward_affine(t)
        return cam, cam_, out1, out2, out3, out1_, out2_, out3_, x1_e1, x2_e1, x3_e1, x4_e1, x1_e2, x2_e2, x3_e2, x4_e2, out_, out
        # return out
