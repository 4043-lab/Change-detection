...
class Network(nn.Module):
    ...
    def forward_origin(self, t):
        ...
        t1 = F.interpolate(t1, scale_factor=1.5, mode='bilinear', align_corners=True)
        t2 = F.interpolate(t2, scale_factor=1.5, mode='bilinear', align_corners=True)
        ...
        return cam3, cls3, out1, out2, out3

    def forward(self, t):
        cams, cls, out1, out2, out3 = self.forward_origin(t)
        return cams, cls, out1, out2, out3
        # return cls
