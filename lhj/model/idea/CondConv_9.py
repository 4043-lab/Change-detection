...
class Resnet_bottle(nn.Module):
    def __init__(self):
        ...
        self.head1 = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
        self.head2 = nn.Conv2d(256, 2, kernel_size=3, stride=1, padding=1)
        self.head3 = nn.Conv2d(128, 2, kernel_size=3, stride=1, padding=1)
        self.head4 = nn.Conv2d(128, 2, kernel_size=3, stride=1, padding=1)
