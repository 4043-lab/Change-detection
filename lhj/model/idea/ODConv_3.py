...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, downsample=True):
        ...
        self.conv1_1 = nn.Sequential(
            ...
            ODConv2d(in_ch, out_ch // self.expansion, kernel_size=1, stride=1, padding=0, kernel_num=4),
        ...
        self.conv3_1 = nn.Sequential(
            ...
            ODConv2d(in_planes=out_ch // self.expansion, out_planes=out_ch // self.expansion, kernel_size=3, stride=self.down_stride, padding=1, kernel_num=4),
            nn.BatchNorm2d(out_ch // self.expansion),
            nn.ReLU(inplace=True)
        )
        self.conv1_2 = nn.Sequential(
            # nn.Conv2d(out_ch // self.expansion, out_ch, kernel_size=1, stride=1, padding=0, bias=False),
            ODConv2d(out_ch // self.expansion, out_ch, kernel_size=1, stride=1, padding=0, kernel_num=4),
