...
class ConvLSTM_video(nn.Module):
    ...
    def forward(self, t):
        ...
        video1_out = video1_forw[:,-1] + video1_back[:,-1]
        y1 = self.conv1(video1_out)
        ...
        video2_out = video2_forw[:,-1] + video2_back[:,-1]
        y2 = self.conv2(video2_out)
        ...
        video3_out = video3_forw[:,-1] + video3_back[:,-1]
        y3 = self.conv3(video3_out)
        ...
        video4_out = video4_forw[:,-1] + video4_back[:,-1]
        y4 = self.conv4(video4_out)
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.conv1 = decoder_final(512 * 2, 256)
        self.conv2 = decoder_final(256 * 3, 128)
        self.conv3 = decoder_final(128 * 3, 64)
        self.conv4 = decoder_final(64 * 3, 64)
