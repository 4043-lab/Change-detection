...
from model.Attention.CEEF import CEEF
...
class Network(nn.Module):
    def __init__(self):
        ...
        reduction = 8
        self.ceef1 = CEEF(channel=64, reduction=reduction)
        self.ceef2 = CEEF(channel=128, reduction=reduction)
        self.ceef3 = CEEF(channel=256, reduction=reduction)
        self.ceef4 = CEEF(channel=512, reduction=reduction)
        self.ceef5 = CEEF(channel=512, reduction=reduction)
    ...
    def forward(self, t):
        ...
        y1 = self.ceef1(x1_e1, x1_e2)
        y2 = self.ceef2(x2_e1, x2_e2)
        y3 = self.ceef3(x3_e1, x3_e2)
        y4 = self.ceef4(x4_e1, x4_e2)
        y5 = self.ceef5(x5_e1, x5_e2)
