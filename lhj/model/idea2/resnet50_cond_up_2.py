...
class Network(nn.Module):
    def __init__(self):
        ...
        self.conv_t1 = nn.ConvTranspose2d(3,3,3,2,1,1)
        self.conv_t2 = nn.ConvTranspose2d(3,3,3,2,1,1)
        ...
        self.head = nn.Conv2d(128, 2, kernel_size=3, stride=2, padding=1)
    ...
    def forward(self, t):
        t1 = t[0]
        # t1 = F.interpolate(t1, scale_factor=2, mode='bilinear', align_corners=True)
        t1 = self.conv_t1(t1)

        t2 = t[1]
        # t2 = F.interpolate(t2, scale_factor=2, mode='bilinear', align_corners=True)
        t2 = self.conv_t2(t2)
