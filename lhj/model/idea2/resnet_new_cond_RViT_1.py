...
class Bottleneck(nn.Module):
    def __init__(self, in_ch, out_ch, downsample=True):
        ...
        # self.attention = SEAttention(channel=out_ch, reduction=8)
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.decoder2 = decoder(768, 384)
        self.decoder3 = decoder(384, 192)
        self.decoder4 = decoder(192, 96)

        self.head = nn.Conv2d(96, 2, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, t):
        ...
        y2 = torch.cat([x2_e1, x2_e2, v2], dim=1)
