...
from model.Attention.AW2 import AW
...
class Network(nn.Module):
    def __init__(self):
        ...
        model_load1 = 'result/idea2/resnet50_cond_1/checkpoints/best_model_epoch092_f_score0.9128_iou0.8396.pth'
    ...
    def forward(self, t):
        l1, l2, l3, l4, l_out = self.lstm(t)
        r1, r2, r3, r4, r_out = self.resnet(t)
        # print(l1.shape)
        # print(l2.shape)
        # print(l3.shape)
        # print(l4.shape)
