...
class Network(nn.Module):
    ...
    def forward(self, t1, t2):
        # t1 = t[0]
        t1 = F.interpolate(t1, scale_factor=2, mode='nearest', recompute_scale_factor=True)
        # t2 = t[1]
        t2 = F.interpolate(t2, scale_factor=2, mode='nearest', recompute_scale_factor=True)
        ...
        out1 = F.interpolate(out1, scale_factor=0.5, mode='nearest', recompute_scale_factor=True)
        out2 = F.interpolate(out2, scale_factor=0.5, mode='nearest', recompute_scale_factor=True)
        out3 = F.interpolate(out3, scale_factor=0.5, mode='nearest', recompute_scale_factor=True)
        out4 = F.interpolate(out4, scale_factor=0.5, mode='nearest', recompute_scale_factor=True)
        out = F.interpolate(out, scale_factor=0.5, mode='nearest', recompute_scale_factor=True)
