...
class Network(nn.Module):
    def __init__(self):
        ...
        self.AW4 = AW(channel=64)

        self.conv1 = Bottleneck(512, 256, downsample=False)
        self.conv2 = Bottleneck(256, 128, downsample=False)
        self.conv3 = Bottleneck(128, 64, downsample=False)
        self.conv4 = Bottleneck(64, 64, downsample=False)

        self.conv_l1 = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
        self.conv_l2 = nn.Conv2d(256, 2, kernel_size=3, stride=1, padding=1)
        self.conv_l3 = nn.Conv2d(128, 2, kernel_size=3, stride=1, padding=1)
        self.conv_l4 = nn.Conv2d(64, 2, kernel_size=3, stride=1, padding=1)
        self.conv_r1 = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
        self.conv_r2 = nn.Conv2d(256, 2, kernel_size=3, stride=1, padding=1)
        self.conv_r3 = nn.Conv2d(128, 2, kernel_size=3, stride=1, padding=1)
        self.conv_r4 = nn.Conv2d(64, 2, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, t):
        ...
        l1 = self.conv_l1(l1)
        l1 = F.interpolate(l1, scale_factor=8, mode='bilinear', align_corners=True)
        l2 = self.conv_l2(l2)
        l2 = F.interpolate(l2, scale_factor=4, mode='bilinear', align_corners=True)
        l3 = self.conv_l3(l3)
        l3 = F.interpolate(l3, scale_factor=2, mode='bilinear', align_corners=True)
        l4 = self.conv_l4(l4)

        r1 = self.conv_r1(r1)
        r1 = F.interpolate(r1, scale_factor=8, mode='bilinear', align_corners=True)
        r2 = self.conv_r2(r2)
        r2 = F.interpolate(r2, scale_factor=4, mode='bilinear', align_corners=True)
        r3 = self.conv_r3(r3)
        r3 = F.interpolate(r3, scale_factor=2, mode='bilinear', align_corners=True)
        r4 = self.conv_r4(r4)
        ...
        # print(r4.shape)
        # return out
        return [l1,l2,l3,l4,r1,r2,r3,r4,out]
