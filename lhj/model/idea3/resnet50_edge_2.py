...
class Network(nn.Module):
    def __init__(self):
        ...
        # self.head_edge1 = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
        # self.head_edge2 = nn.Conv2d(256, 2, kernel_size=3, stride=1, padding=1)
        # self.head_edge3 = nn.Conv2d(128, 2, kernel_size=3, stride=1, padding=1)
        self.head_edge4 = nn.Conv2d(64, 2, kernel_size=3, stride=1, padding=1)
        self.bn_edge4 = nn.BatchNorm2d(2)
        self.relu = nn.ReLU()

        self.head = nn.Conv2d(64+2, 2, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, t1, t2):
        ...
        edge4 = self.head_edge4(out4)


        # out = self.head(out4)
        out = self.head(torch.cat([out4, edge4], dim=1))
