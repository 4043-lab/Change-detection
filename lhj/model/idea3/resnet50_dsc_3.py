...
class Bottleneck(nn.Module):
    def __init__(self, in_ch, out_ch, downsample=True):
        ...
        self.conv3_1_x = DSConv_pro(out_ch // self.expansion, out_ch // self.expansion, 25, 1.0, 0, True)
        self.conv3_1_y = DSConv_pro(out_ch // self.expansion, out_ch // self.expansion, 25, 1.0, 1, True)
