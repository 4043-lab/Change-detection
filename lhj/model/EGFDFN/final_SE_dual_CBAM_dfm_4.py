...
class EGFDFN(nn.Module):
    ...
    def encoder(self, x1, x2):
        ...
        return dif_x1, dif_x2, dif_x3, dif_x4, dif_x5, x1_d1, x1_d2
    ...
    def forward(self, t1, t2):
        ...
        x1, x2, x3, x4, x5, dd1, dd2 = self.encoder(t1, t2)
        ...
        return d6_out, d5_out, d4_out, d3_out, d2_out, d3_edge, d2_edge, dd1, dd2
